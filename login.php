<?php
    ...
    $query = "INSERT INTO employee (Email, Password, Nama, IdCabang) VALUES ('$aEmail', '$aPassword', 'Helen Ruth Yemima', 1)";
    ...
    <div class="cont">
        ...
        <div class="login form">
            ...
            <form action="" method="POST">
                ...
                <input type="email" id="email" name="email" placeholder="example@vast.com" value="<?php echo $email; ?>" required>
                <?php echo $eEmail ?>

                <label for="password">Password</label>
                <input type="password" id="password" placeholder="Pa$5w0Rd" name="password" value="" required>
                <?php echo $ePassword ?>
