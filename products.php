    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="top">
                ...
                <a href="formProducts.php" class="add">
            ...
            <div class="main">
                    ...
                    <div class="input">
                        ...
                        <div class='filter'>
                            ...
                            <script>
                                ...
                                function addHMTL(data, container, type) {
                                    let textHTML = "";
                                ...
                                <?php
                                    $queryK = "SELECT DISTINCT Kategori FROM produk ORDER BY Kategori ASC";
                                ...
                                <?php
                                    ...
                                    $queryS = "SELECT DISTINCT IdSupplier FROM produk ORDER BY IdSupplier ASC";
                                    $resultS = mysqli_query($connect, $queryS);
                                    $S = [];
                                    while($rowS = mysqli_fetch_array($resultS)) {
                                        array_push($S, $rowS["IdSupplier"]);
                                    }
                                ...
                                <?php
                                    ...
                                    $S = '(' . implode(',', $S) .')';
                                    $queryTemp2 = "SELECT * FROM suppliers WHERE Id IN " . $S . " ORDER BY Nama ASC";
                                    $resultTemp2 = mysqli_query($connect, $queryTemp2);
                                    while($rowTemp2 = mysqli_fetch_array($resultTemp2)) {
                                ?>
                                        dataS.push("<?php echo $rowTemp2['Id']; ?>");
                                <?php
                                    }
                                ?>
                                ...
                                fSupplier.addEventListener('click', () => {
                                    addHMTL(dataS, sSupplier, "supplier");
                                }, {once: true});
                            </script>
                        </div>
                        ...
                        <div class="reset" onclick="reset()">
                            ...
                            <script>
                                ...
                                let filterS = document.getElementsByName("fSupplier[]");
                ...
                <?php
                    ...
                    if (!isset($_GET['search'])) {
                        $queryS = "SELECT * FROM produk ORDER BY NamaProduk ASC";
                    } else {
                        $search = $_GET['search'];
                ...
                <?php
                        ...
                        $queryS = "SELECT * FROM produk WHERE " . $searchby . " LIKE '%" . $search . "%'";
                ...
                ?>
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            if ($rowS["IdSupplier"] == 0) {
                                $supplier = "Belum ada";
                                echo "<td class='null'>" . $supplier . "</td>";
                            } else {
                                $queryTemp = "SELECT * FROM suppliers WHERE Id = '" . $rowS["IdSupplier"] . "'";
                                $resultTemp = mysqli_query($connect, $queryTemp);
                                $rowTemp = mysqli_fetch_array($resultTemp);
                                $supplier = $rowTemp["Nama"];
                                echo "<td>" . $supplier . "</td>";
                            }
                        ?>
                            </tr>
