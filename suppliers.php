    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="top">
                ...
                <a href="formSuppliers.php" class="add">
            ...
            <div class="main">
                    ...
                    <div class="input">
                        <div class='search'>
                            ...
                            <select name="searchby" id="searchby">
                                <option value="Nama" selected>Name</option>
                        ...
                        <div class='filter'>
                            ...
                            <script>
                                ...
                                function addHMTL(data, dataName, container) {
                                    let textHTML = "";
                                    for (let i = 0; i < data.length; i++) {
                                        ...
                                        textHTML += "<input type='checkbox' id='" + dataNow + "' name='fProvince[]' value='" + dataNowId + "'";
                                        <?php
                                ...
                                <?php
                                    $queryP = "SELECT DISTINCT Provinsi FROM address WHERE Jenis = 'supplier' ORDER BY Provinsi ASC";
                                    $resultP = mysqli_query($connect, $queryP);
                                    while($rowP = mysqli_fetch_array($resultP)) {
                                ?>
                                        data.push(<?php echo $rowP['Provinsi']; ?>);
                                ...
                                fProvince.addEventListener('click', () => {
                                    ...
                                    request.onload = function () {
                                        ...
                                        addHMTL(data, dataName, sProvince);
                                    };
                                    request.send();
                                }, {once: true});
                            </script>
                        ...
                        <div class="reset" onclick="reset()">
                            ...
                            <script>
                                ...
                                let filter = document.getElementsByName("fProvince[]");
                ...
                <?php
                    ...
                    if (!isset($_GET['search'])) {
                        $queryS = "SELECT * FROM suppliers ORDER BY Nama ASC";
                    } else {
                        $search = $_GET['search'];
                ...
                <?php
                        ...
                        $queryS = "SELECT * FROM suppliers JOIN address ON suppliers.Id = address.IdToko WHERE address.Jenis = 'supplier' AND " . $searchby . " LIKE '%" . $search . "%'";
